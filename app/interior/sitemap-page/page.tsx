      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
        ...
        <section>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>
              <Link href="/interior" className="hover:text-foreground">
                인테리어 업체 모음
              </Link>
            </li>
            <li>
              <Link href="/interior/register" className="hover:text-foreground">
                업체 등록하기
              </Link>
            </li>
            <li>
              <Link href="/interior/quote" className="hover:text-foreground">
                무료 개원 상담 신청
              </Link>
            </li>
          </ul>
